...
function mcbase_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  '#type'           => 'checkbox',
  '#title'          => t('Enable overlay grid'),
  '#default_value'  => theme_get_setting('mcbase_enable_overlay_grid'),
  '#description'    => t('Enable a default grid overlay to check column and other positioning'),
  );
  
  $form['themedev']['mcbase_grid_colour'] = array(
  '#type'           => 'radios',
  '#title'          => t('Overlay grid colour preference'),
  ...
  $form['themedev']['mcbase_overlay_default_state'] = array(
  '#type'           => 'radios',
  '#title'          => t('Overlay default state'),
  '#options'        => array('grid-enabled' => 'Enabled', 'grid-disabled' => 'Disabled'),
  '#default_value'  => theme_get_setting('mcbase_overlay_default_state'),
  '#description'    => t('Choose whether to enable or disable the overlay grid on page load.'),
  );
}
